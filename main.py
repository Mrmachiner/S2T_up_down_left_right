...
if __name__ == "__main__":
    ...
    #     nn.predict("test/back/demo9.484276840927278.wav.ogg",le,"trained_cnn.h5")
    #     nn.predict("test/back/demo9.759566731506595.wav.ogg",le,"trained_cnn.h5")
    #     nn.predict("test/back/demo9.841398034944248.wav.ogg",le,"trained_cnn.h5")
    #     nn.predict("test/up/demo9.703266511112123.wav.ogg",le,"trained_cnn.h5")
    #     nn.predict("test/up/demo9.884226894425245.wav.ogg",le,"trained_cnn.h5")
    #     nn.predict("test/up/demo9.929471352116396.wav.ogg",le,"trained_cnn.h5")
    #
    #
    # elif sys.argv[1] == "mlp":
    #
    ...
    #     # clf.predict("dataset/001 - Dog bark/1-30226-A.ogg",le,"svm.pkl")
